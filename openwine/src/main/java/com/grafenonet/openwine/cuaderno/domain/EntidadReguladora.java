...
import com.grafenonet.openwine.cuaderno.enums.ClasificacionEntidadReguladora;
import com.grafenonet.openwine.maestros.domain.Municipio;

@Entity
@Table(name="entidad_reguladora")
public class EntidadReguladora extends BaseEntity implements Serializable {
	...
	public String toString() {
		return "EntidadReguladora [id=" + getId() + ", nombre=" + nombre
